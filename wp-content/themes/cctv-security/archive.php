...
<div class="container">
	...
	<div class="content-area">
		<main id="skip-content" class="site-main" role="main">
			<?php
		    $cctv_security_archive_page_sidebar = get_theme_mod('cctv_security_archive_page_sidebar','Right Sidebar');
		    if($cctv_security_archive_page_sidebar == 'Left Sidebar'){ ?>
		    	<div class="row">
			...
			<?php }else if($cctv_security_archive_page_sidebar == 'Right Sidebar'){ ?>
				<div class="row">
					<div class="content_area col-lg-8 col-md-8">
						<section id="post_section">
							<?php
			...
			<?php }else if($cctv_security_archive_page_sidebar == 'One Column'){ ?>
			...
			<?php }else if($cctv_security_archive_page_sidebar == 'Three Columns'){ ?>
				<div class="row">
					<div id="sidebar" class="col-lg-4 col-md-4"><?php dynamic_sidebar('sidebar-1'); ?>
					</div>
			...
			<?php }else if($cctv_security_archive_page_sidebar == 'Four Columns'){ ?>
				<div class="row">
			...
			<?php }else if($cctv_security_archive_page_sidebar == 'Grid Layout'){ ?>
		    	<div class="content_area">
					<section id="post_section" >
						<div class="row">
							<?php
