...
<div class="container">
	<header class="page-header">
		<?php if ( have_posts() ) : ?>
			<h2 class="search-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s','cctv-security'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h2>
		<?php else : ?>
			<h3 class="page-title"><?php esc_html_e( 'Nothing Found', 'cctv-security' ); ?></h3>
		<?php endif; ?>
	</header>

	<div class="content-area">
		<main id="skip-content" class="site-main" role="main">
			<?php $cctv_security_layout_option = get_theme_mod( 'cctv_security_archive_page_sidebar', 'Right Sidebar' );
			        ...
			        <div class="content_area col-lg-8 col-md-8">
				    	<section id="post_section">
							...
							if ( have_posts() ) :
								...
								<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'cctv-security' ); ?></p>
								<?php
									get_search_form();
