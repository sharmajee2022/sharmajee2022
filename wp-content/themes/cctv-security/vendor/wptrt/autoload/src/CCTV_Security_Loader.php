...
class CCTV_Security_Loader {
	 ...
	 * @return void
	 */
	public function cctv_security_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function cctv_security_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function cctv_security_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function cctv_security_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->cctv_security_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function cctv_security_load( $class ) {
